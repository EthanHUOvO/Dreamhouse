...
const required=[
  ...
  'components/contractor/OrderSidebar.tsx','components/contractor/ContractorOrderDetail.tsx','components/shared/PascalViewer.tsx','components/shared/PascalWalkthroughController.tsx',
  'lib/demo-orders.ts','lib/order-store.ts','lib/downstream.ts','lib/house-scene.ts','lib/walkthrough-runtime.ts'
]
...
for(const x of ['居住需求引导','请选择居住人数','单身贵族','双人世界','三口之家','男士','女士','生成并应用方案','保存状态','提交设计变更','确认设计并进入生产','调整家具','进入漫游','walkthroughMode','onNudgeItem','onRotateItem','onDragCommit'])if(!design.includes(x))throw new Error(`Design workflow missing: ${x}`)
...
for(const x of [
  ...
  'PascalWalkthroughController',"setWallMode('up')",'setWalkthroughMode(true)','selectionManager="custom"','左键 / E 开关门','walkthroughReady'
